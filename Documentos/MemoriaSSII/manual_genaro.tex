...
\item [$8^{a}$ Inicial:] consiste en una lista desplegable que nos permite elegir entre un número comprendido entre 1 y 7. La octava aconsejable es la 4, con una octava m\'as baja obtendr\'as un sonido m\'as grave, mientras que si escoges una octava mayor, el sonido ser\'a m\'as agudo.
...
\begin {itemize}
\item \emph{rear Progresi\'on:} crea una nueva progresi\'on con los par\'ametros de mutaci\'on anteriormente especificados
